...
<section class="jumbotron text-center">
    <div class="container">
        ...
        <?php
                    ...
                    $onayli_icerik = mysqli_query($baglanti, "select haber_baslik,kategori,tarih,haber_icerik,haber_id,resim from icerik where onay ='1' order by tarih desc ");
        ...
        echo "<div class='card-header'>Kategori: $kategori<div class='date'>$tarih</div></div><div class='card-body'>";
